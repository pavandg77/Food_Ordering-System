<%@ page import="com.example.foodorderingsystem.model.*"%>
<%@ page import="com.example.foodorderingsystem.repository.*"%>
<%@ page import ="org.springframework.context.ApplicationContext"%>
<%@ page import ="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@ page import ="java.sql.*"%>
<%@ page import ="java.util.*"%>
<%@ page import="com.example.foodorderingsystem.model.Admin" %>
<%@ page import="com.example.foodorderingsystem.utility.Helper" %>
...
<%
    ...
    FoodRepo foodRepo = context.getBean(FoodRepo.class);
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <%
                if(user!=null)
                {
                    List<Cart> l= cartRepo.findByUserId(user.getId());
