<%@ page import="com.example.foodorderingsystem.model.Category" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.example.foodorderingsystem.model.User" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.foodorderingsystem.repository.CategoryRepo" %>
<%@ page import="com.example.foodorderingsystem.repository.UserRepo" %>
...
<%
    ...
    li = categoryRepo.findAll();
    List<User> listOfAllUsers = new ArrayList<>();
    listOfAllUsers = userRepo.findAll();
%>
        ...
        <div class="col-md-4">
            <div class="card hover" data-toggle="modal"
                ...
                <div class="card-body text-center">
                    ...
                    <h1 class="text-lowercase text-muted"><%=orderRepo.count()%></h1>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <%
                                Category cat = null;
                                Optional<Category> optional = categoryRepo.findById(p.getCategoryId());
    ...
    <div class="modal-dialog modal-lg modal-size" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <%
                    List<Order> lor = orderRepo.findAll();
                    if (lor == null) {
                %>
                    ...
                    <table class="table">
                        ...
                        <%
                            for (Order o : lor) {
                                ...
                                Optional<Food> of = foodRepo.findById(o.getFoodId());
                                Food f = null;
                                ...
                                Optional<User> ou = userRepo.findById(o.getUserId());
                                User u = null;
